...
exercises:
  ...
  - id: ex-day-02-output-input-guided
    ...
    answer: 'name = "요섭!"
      ...
      print("안녕,", name)'
    hint: 첫 문자열을 '요섭'에서 '요섭!'로 바꾼 뒤 name="요섭" → print가 name을 읽음 → 안녕, 요섭 순으로 따라가세요.
  ...
  - id: ex-day-02-output-input-debug
    ...
    prompt: 아래 코드의 핵심 표현 '"익명"'을 점검하고 올바른 작동을 복원하세요. 변수 이름을 따옴표로 감싸 값 대신 글자 name을 출력함 오류도 함께 경계하세요.
    starter: '"익명" = "요섭"
