...
exercises:
  ...
  - id: ex-day-91-cross-language-review-guided
    ...
    prompt: 예시를 직접 타이핑한 뒤 처음 등장하는 숫자를 60에서 61로 바꿔 보세요. 출력도 먼저 예측하세요.
    starter: 'expected = {"total": 60, "count": 3}
  ...
  - id: ex-day-91-cross-language-review-debug
    ...
    prompt: 아래 코드의 핵심 표현 'actual is expected'을 점검하고 올바른 작동을 복원하세요. 객체 동일성 is로 독립된 결과의 값 일치를 검사함 오류도 함께 경계하세요.
    starter: 'expected = {"total": 60, "count": 3}
...
3. 처음 등장하는 숫자를 60에서 61로 바꾼 뒤 어느 단계부터 결과가 달라질지 예측하세요.
